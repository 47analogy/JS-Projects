...
// const sortedInventors = inventors[year.sort();
...
const oldestSort = inventors.sort((x, y) => {
...
// const list = Array.from(categoryDiv.querySelectorAll("a"));
// const deList = list
...
const alphabetical = people.sort((lastPerson, nextPerson) => {
	const [xLastPerson, xNextPerson] = lastPerson.split(", ");
	const [yLastPerson, yNextPerson] = nextPerson.split(", ");
	return xLastPerson > yLastPerson ? 1 : -1;
});
